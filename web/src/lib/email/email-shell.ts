...
<tr><td class="email-header" align="center" bgcolor="#1f3d3a" style="padding:24px 30px 22px;border-bottom:3px solid #c8a26a;background:#1f3d3a"><a href="${escapeEmailHtml(baseUrl)}"><img src="${escapeEmailHtml(brand.logoUrl)}" width="260" alt="${escapeEmailHtml(brand.siteName)}" style="display:block;width:100%;max-width:260px;height:auto;border:0;color:#f3ede6;font-family:Georgia,'Times New Roman',serif;font-size:20px"></a></td></tr>
<tr><td class="email-content" style="padding:36px 36px 30px;color:#282828">${content}</td></tr>
<tr><td class="email-footer" bgcolor="#282828" style="padding:26px 30px;background:#282828;color:#d8cec0;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:1.6;text-align:center">
