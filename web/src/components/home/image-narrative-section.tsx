...
export function ImageNarrativeSection({
  ...
  return (
    <section
      ...
      className="bg-linen pt-24 pb-32 text-charcoal sm:pt-32 sm:pb-40 lg:pt-40 lg:pb-48"
      id={id}
    >
      <figure>
      ...
      <div className="mx-auto grid w-full max-w-7xl pt-24 px-6 sm:px-8 sm:pt-28 md:px-10 lg:grid-cols-12 lg:gap-x-12 lg:pt-36 xl:gap-x-20">
        ...
        <h2
          className="mt-7 max-w-4xl font-display text-[3rem] leading-[0.98] font-medium tracking-[-0.03em] text-charcoal sm:text-[4rem] lg:col-span-8 lg:col-start-3 lg:mt-0 lg:text-[5rem]"
          id={headingId}
        >
          {heading}
        </h2>
        <p className="mt-10 max-w-xl font-body text-base leading-8 text-charcoal/75 sm:text-lg sm:leading-9 lg:col-span-5 lg:col-start-8 lg:row-start-2 lg:mt-16">
          {paragraph}
        </p>
      </div>
    </section>
