...
export type {EditorialContainerSize} from './editorial-container'
export {EditorialDivider} from './editorial-divider'
export {EditorialFigure} from './editorial-figure'
export type {
  EditorialFigureCaptionAlignment,
  EditorialFigureCaptionContainer,
