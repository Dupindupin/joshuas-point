...
const stayDetails = [
  {
    label: 'Check-in',
    value: stayPolicy.checkIn,
  },
  {
    label: 'Check-out',
    value: stayPolicy.checkOut,
  },
  {
    label: 'Minimum stay',
    value: stayPolicy.minimumStay,
  },
    ...
    <>
      ...
      <main className="bg-canvas">
        <EditorialPageHero
          ...
          introduction="The practical details to know before deciding whether Joshua’s Point feels right for your stay."
            ...
            <EditorialGrid gap="generous">
              ...
              <div className="lg:col-span-8 lg:col-start-3">
                ...
                <EditorialText className="mt-11 max-w-2xl" variant="body">
                  Before a stay is confirmed, we want you to understand the house, its setting, and
                  the terms that apply to your dates.
                </EditorialText>
              </div>
            </EditorialGrid>
          </EditorialContainer>
            ...
            <EditorialContainer>
              <EditorialGrid gap="generous">
                ...
                <div className="lg:col-span-7 lg:col-start-4">
                  <EditorialText headingSize="small" id="stay-amenities-title" variant="heading">
